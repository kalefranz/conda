    ...
    def get_reduced_index(self, specs, strict_channel_priority=False):
        ...
        while specs_queue:
            ...
            if strict_channel_priority and add_these_precs2:
                sole_source_channel_name = self._get_strict_channel(add_these_precs2[0].name)
                add_these_precs2 = tuple(prec for prec in add_these_precs2 if prec.channel.name == sole_source_channel_name)
